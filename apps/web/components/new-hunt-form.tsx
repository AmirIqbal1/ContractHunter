...
export function NewHuntForm() {
  ...
  return <form className="card form-card" onSubmit={submit}>
    <div className="mock-note">V0.1 uses a harmless mock scanner. Findings are demonstration data and do not reflect repository contents.</div>
