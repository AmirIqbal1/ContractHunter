...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body><div className="shell">
    <aside className="sidebar">
      ...
      <nav className="nav"><Link href="/">Overview</Link><Link href="/hunts/new">New Hunt</Link><Link href="/findings">Findings</Link></nav>
      <div className="system"><span className="online" />Local system online<br /><span style={{ marginLeft: 14 }}>V0.1.4 / Slither + Aderyn</span></div>
    </aside>
